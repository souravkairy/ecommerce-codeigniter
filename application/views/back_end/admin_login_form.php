...
<body>
  ...
  <div id="login-page">
    <div class="container">
      ...
      <form class="form-login" method="post" action="<?php echo base_url('admin_auth')?>">
        <h2 class="form-login-heading">sign in now</h2>
        <div class="login-wrap">
          <input type="text" class="form-control" placeholder="User ID / Email" autofocus name="user_email">
          <br>
  ...
  <script type="text/javascript" src="<?php echo base_url()?>backend_asset/lib/jquery.backstretch.min.js"></script>
  <script>
    $.backstretch("<?php echo base_url()?>backend_asset/img/login-bg.jpg", {
      speed: 500
    });
  </script>
</body>
