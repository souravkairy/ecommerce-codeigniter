                  ...
                  <table class="table table-inbox table-hover">
                    <tbody>
                      ...
                      <tr class="unread">
                        ...
                        <td class="view-message  dont-show"><a href="mail_view.html"><?php echo $all_mail_by_id->c_name ?></a></td>
                        <td class="view-message "><a href="mail_view.html"><?php echo $all_mail_by_id->m_desc ?></a></td>
                        
                        <td class="view-message  text-right"><?php echo $all_mail_by_id->time; ?></td>
                      </tr>
